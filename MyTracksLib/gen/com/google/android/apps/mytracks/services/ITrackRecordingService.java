 ...
 * Original file: /home/mynguyen/workspace/Android/mytracks/MyTracksLib/src/com/google/android/apps/mytracks/services/ITrackRecordingService.aidl
 */
...
case TRANSACTION_updateCalorie:
{
data.enforceInterface(DESCRIPTOR);
this.updateCalorie();
reply.writeNoException();
...
/**
   ...
   */
@Override public void updateCalorie() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_updateCalorie, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_updateCalorie = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
}
/**
   * Starts gps.
   */
...
/**
   * Updates the calorie of current recording track. 
   */
public void updateCalorie() throws android.os.RemoteException;
}
